...
class StockRepositoryImpl @Inject constructor(
    ...
    override suspend fun getCompanyListings(
        ...
        return flow {
            ...
            remoteListings?.let { localListings ->
                dao.clearCompanyListings()
                dao.insertCompanyListings(
                    localListings.map { it.toCompanyListingEntity() }
                )
                emit(Resource.Success(
    ...
    override suspend fun getIntradayInfo(symbols: String): Resource<List<IntradayInfo>> {
        return try {
